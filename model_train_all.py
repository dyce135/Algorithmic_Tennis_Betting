...
from tensorflow.keras.layers import Dense, TimeDistributed, Add, Bidirectional, LSTM
...
model = seq2seq_model.bidirectional(data, n_steps=n_length, features_out_num=features_out_num,

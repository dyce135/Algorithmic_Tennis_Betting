...
def seq2seq(input_dim, output_dim, latent_dim, learning_rate=0.001):
    ...
    encoder_last_h1 = BatchNormalization(momentum=0.3)(encoder_last_h1)
    encoder_last_c = BatchNormalization(momentum=0.3)(encoder_last_c)
    decoder = RepeatVector(output_train.shape[1])(encoder_last_h1)
    decoder = LSTM(latent_dim, activation='elu', dropout=0.2, recurrent_dropout=0.2, return_state=False,

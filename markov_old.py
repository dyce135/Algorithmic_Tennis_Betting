...
set_initial_state = pd.DataFrame(data=matrix, columns=col_row_names3)
set_initial_state.at[0, "0-0"] = 1
...
def predict1(gamescore, pwin1, pwin2, ptie1, pset_v1, match_initial_state, set_initial_state, game_initial_state,
             tb_initial_state):
    s1match = match_initial_state
    s1set = set_initial_state
...
def predict2(setscore, gamescore, pwin1, pwin2, ptie1, pset_v1, match_initial_state, set_initial_state,
...
def predict3(gamescore, pwin1, pwin2, ptie1, pset_v1, match_initial_state, set_initial_state, game_initial_state,
             tb_initial_state):
    s1match = match_initial_state
    s1set = set_initial_state
    s1game = game_initial_state
...
def tennis_model(ppoint_srv1, ppoint_srv2, setscore, gamescore, match_initial_state, set_initial_state,
                 game_initial_state, tb_initial_state):
    ...
    ans = prob_set(temp, temp1, temp2, set_initial_state)
    ans = pd.DataFrame(data=ans, columns=col_row_names3)
    ...
    if (setscore == "0-0"):
        prob_entire_match = predict1(gamescore, temp, temp1, temp2, temp3, match_initial_state, set_initial_state,
                                     game_initial_state, tb_initial_state)
    if setscore == "1-1":
        prob_entire_match = predict3(gamescore, temp, temp1, temp2, temp3, match_initial_state, set_initial_state,
                                     game_initial_state, tb_initial_state)
...
ans = tennis_model(0.6, 0.6, "0-0", "0-1", match_initial_state, set_initial_state, game_initial_state, tb_initial_state)
ans = pd.DataFrame(data=ans, columns=col_row_names4)
